...
public class LevelLoseScreen extends Screen {
    ...
    public void initialize() {
        loseMessage = new SpriteFont("You lose!", 320, 239, "Arial", 30, Color.white);
        instructions = new SpriteFont("Press Space to try again or Escape to go back to the main menu", 90, 279,"Arial", 20, Color.white);
